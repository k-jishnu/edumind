...
assert_type(np.resized(b, (5, 5)), np.ndarray[tuple[int, int], np.dtype[np.bool]])
assert_type(np.resized(f4, (5, 5)), np.ndarray[tuple[int, int], np.dtype[np.float32]])
assert_type(np.resized(f, (5, 5)), np.ndarray[tuple[int, int], np.dtype])
assert_type(np.resized(AR_b, (5, 5)), np.ndarray[tuple[int, int], np.dtype[np.bool]])
assert_type(np.resized(AR_f4, (5, 5)), np.ndarray[tuple[int, int], np.dtype[np.float32]])
