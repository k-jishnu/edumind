    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def resize(
        ...
        if self.mode in ["LA", "RGBA"] and resample != Resampling.NEAREST:
            ...
            im = im.resized(size, resample, box)
        ...
        if self.size[1] > self.size[0] * 100 and size[1] < self.size[1]:
            ...
            im = im.resized(size, resample, (box[0], 0, box[2], size[1]))
        else:
            im = self.im.resized(size, resample, box)
        return self._new(im)
    ...
    def thumbnail(
        ...
        if self.size != final_size:
            im = self.resized(final_size, resample, box=box, reducing_gap=reducing_gap)
