...
try:
    ...
    def resizer (pic, newsize):
        ...
        return cv2.resized(+pic.astype('uint8'), (lx, ly),
    ...
    try:
        ...
        def resizer(pic, newsize):
            ...
            resized_pil = pilim.resized(newsize[::-1], Image.ANTIALIAS)
...
def resize(clip, newsize=None, height=None, width=None, apply_to_mask=True):
    ...
    >>> myClip.resized( (460,720) ) # New resolution: (460,720)
    >>> myClip.resized(0.6) # width and heigth multiplied by 0.6
    >>> myClip.resized(width=800) # height computed automatically.
    >>> myClip.resized(lambda t : 1+0.02*t) # slow swelling of the clip
