...
def volumex(clip, factor):
    ...
    This effect is loaded as a clip method when you use from moviepy import ImageClip, AudioFileClip, concatenate_videoclips,
    ...
    >>> newclip = clip.volumex(2) # only if you used "from moviepy import ImageClip, AudioFileClip, concatenate_videoclips"
    """
